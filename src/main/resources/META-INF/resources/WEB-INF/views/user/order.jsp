    ...
    <div class="section">
      <div class="container">
        <h1 class="order-title">
          <i class="fa fa-shopping-bag"></i> Thông Tin Đặt Hàng
        </h1>
          ...
          <div class="col-md-4">
            <div class="order-summary">
              <div class="order-summary-title">
                <i class="fa fa-list-alt"></i> Đơn hàng của bạn
              </div>
      ...
      function renderOrderItems() {
        ...
        selectedItems.forEach(function (item) {
          ...
          itemDiv.innerHTML =
            ...
            escapeHtml(item.name) +
            "</div>" +
            '<div class="order-item-qty">Số lượng: ' +
            item.quantity +
            "</div>" +
            "</div>" +
      ...
      function placeOrder() {
        ...
        fetch("${pageContext.request.contextPath}/api/orders/create", {
          ...
          .then(function (order) {
            ...
            modalBody.innerHTML =
              '<p style="margin-bottom: 10px;"><strong>Mã đơn hàng:</strong> #' +
              order.orderId +
              "</p>" +
              '<p style="margin-bottom: 10px;"><strong>Tổng tiền:</strong> ' +
