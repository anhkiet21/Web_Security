        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-title">
              <h3 class="title">
                <i class="fa fa-heart"></i> Sản phẩm yêu thích của bạn
              </h3>
            </div>
          </div>
        </div>
        ...
        <div class="row" id="wishlistContainer">
          ...
          <div class="col-md-12 text-center" style="padding: 40px 0">
            <i
              ...
              style="font-size: 48px; color: #d10024"
            ></i>
        ...
        <div class="row" id="emptyWishlist" style="display: none">
          <div class="col-md-12">
            ...
            >
              <i
                class="fa fa-heart-o"
                style="font-size: 80px; color: #ddd; margin-bottom: 20px"
              ></i>
              <h3 style="color: #666; margin-bottom: 10px">
                Chưa có sản phẩm yêu thích
              </h3>
              <p style="color: #999; margin-bottom: 30px">
                Hãy thêm sản phẩm yêu thích để theo dõi!
              </p>
              <a
        ...
        wishlistData.forEach(function (item) {
          ...
          if (item.dealPercentage && item.dealPercentage > 0) {
            dealLabels =
              ...
              '<span class="sale" style="background:#c50b12;color:#fff;padding:4px 6px;border-radius:4px;font-weight:700;box-shadow:0 1px 0 rgba(0,0,0,0.08);border:none;animation:pulse 2s infinite;">-' +
              item.dealPercentage +
              "%</span>" +
          ...
          if (item.dealPercentage && item.dealPercentage > 0) {
            const discountedPrice =
              (item.productPrice * (100 - item.dealPercentage)) / 100;
            ...
            priceHtml =
              ...
              "</del><br>" +
              '<span style="color: #ff4444; font-size: 12px; font-weight: bold; background: #ffe8e8; padding: 1px 5px; border-radius: 3px;">-' +
              item.dealPercentage +
              "%</span><br>" +
          ...
          html +=
            ...
            '<button class="add-to-wishlist" onclick="removeFromWishlist(' +
            item.productId +
            ')" style="color: #D10024;">' +
      ...
      async function loadProductRating(productId) {
        try {
          const response = await fetch(
            ctx + "/api/reviews/product/" + productId + "/stats",
          );
          ...
          console.error(
            "Error loading rating for product " + productId + ":",
            error,
          );
        }
      }
