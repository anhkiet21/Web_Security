<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Ð?t Hàng - CellPhoneStore</title>
    ...
    <body>
        <div class="header">
            <div class="header-container">
                ...
                <a href="/cart" class="btn-back"> Quay l?i gi? hàng</a>
            </div>
        </div>

        <div class="container">
            <h1> Thông Tin Ð?t Hàng</h1>
                ...
                <div class="order-form-section">
                    ...
                    <form id="orderForm">
                        <div class="form-group">
                            <label class="form-label required">H? và tên</label>
                        ...
                        <div class="form-group">
                            <label class="form-label required">Ð?a ch? giao hàng</label>
                            <textarea class="form-input" id="address" name="address"
                                placeholder="S? nhà, tên du?ng, phu?ng/xã, qu?n/huy?n, t?nh/thành ph?"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-input" id="notes" name="notes"
                                placeholder="Ghi chú thêm (không b?t bu?c)"></textarea>
                        </div>
                    </form>
                </div>

                <div class="order-summary">
                    <div class="summary-title">Ðon hàng c?a b?n</div>
                    ...
                    <div class="summary-row">
                        ...
                        <span id="shippingFee">Mi?n phí</span>
                    </div>
        ...
        <div id="successModal" class="modal">
            <div class="modal-content">
                ...
                <h2 class="modal-title">Ð?t hàng thành công!</h2>
                <div class="modal-body" id="modalBody"></div>
                <div class="modal-buttons">
                    <button class="btn-modal btn-primary" onclick="goToShop()">Ti?p t?c mua s?m</button>
                    <button class="btn-modal btn-secondary" onclick="viewOrder()">Xem don hàng</button>
                </div>
            </div>
        </div>
