          ...
          <form id="orderForm">
            ...
            <div class="form-group">
              ...
              <textarea
                ...
                id="notes"
                name="notes"
                placeholder="Ghi ch� th�m (kh�ng b?t bu?c)"
              ></textarea>
            </div>
          </form>
        </div>
        ...
        selectedItems.forEach(function (item) {
          ...
          var imgSrc =
            item.imageUrl && item.imageUrl.trim() !== ""
              ? item.imageUrl
              : "data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2260%22 height=%2260%22%3E%3Crect fill=%22%23f0f0f0%22 width=%2260%22 height=%2260%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 font-family=%22Arial%22 font-size=%2210%22 fill=%22%23999%22%3ENo Image%3C/text%3E%3C/svg%3E";

          itemDiv.innerHTML =
            '<img class="order-item-image" src="' +
            imgSrc +
            '" alt="' +
            ...
            escapeHtml(item.name) +
            "</div>" +
            '<div class="order-item-qty">So luong: ' +
            item.quantity +
            "</div>" +
            "</div>" +
      ...
      function placeOrder() {
        ...
        fetch("/api/orders/create", {
          ...
          .then(function (order) {
            ...
            modalBody.innerHTML =
              '<p style="margin-bottom: 10px;"><strong>Ma don hang:</strong> #' +
              order.orderId +
              "</p>" +
              '<p style="margin-bottom: 10px;"><strong>Tong tien:</strong> ' +
