                    ...
                    <div class="section">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="section-title">
                                        <h3 class="title">S?n ph?m bán ch?y</h3>
                                    </div>
                                </div>
                                <!-- /section title -->
                                            ...
                                            <div class="add-to-cart">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${product.stock > 0}">
                                                        <button class="add-to-cart-btn"
                                                            onclick="addToCart(${product.id})">
                                                            <i class="fa fa-shopping-cart"></i> Thêm vào gi?
                                                        </button>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <button class="add-to-cart-btn" disabled
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="newsletter">
                                        <p>Ðang ký nh?n <strong>TIN T?C M?I</strong></p>
                                        <form>
                                            <input class="input" type="email" placeholder="Nh?p email c?a b?n">
                                            <button class="newsletter-btn"><i class="fa fa-envelope"></i> Ðang
                                                ký</button>
                                        </form>
    ...
    var IS_LOGGED_IN = <%= isAuthenticated %>;
                        ...
                        function addToCart(productId) {
                            ...
                            fetch('${pageContext.request.contextPath}/api/cart/add', {
                                ...
                                .then(response => {
                                    ...
                                    else throw new Error('Có l?i x?y ra');
                                })
                                .then(data => {
                        ...
                        function loadFavoriteStates() {
                            fetch('${pageContext.request.contextPath}/api/favorite', {
                                ...
                                .catch(error => console.error('L?i khi t?i tr?ng thái yêu thích:', error));
                        }
                        ...
                        // Load rating cho t?t c? s?n ph?m hi?n th? trên trang
                        function loadAllProductRatings() {
                            // L?y t?t c? product IDs t? các th? rating (c? new và hot products)
                        ...
                        async function loadProductRating(productId, elementId) {
                            try {
                                ...
                                // Update rating stars cho s?n ph?m này
                        ...
                        // Hi?n th? stars d?a trên rating value
