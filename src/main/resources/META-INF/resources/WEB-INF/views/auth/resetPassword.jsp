    ...
    <div class="login-two-col">
      ...
      <div class="promo-col">
        <div class="promo-inner">
          ...
          <p class="promo-sub">
            Nhập email hoặc số điện thoại liên kết với tài khoản của bạn. Chúng
            tôi sẽ gửi hướng dẫn để đặt lại mật khẩu.
          </p>
          ...
          >
            ...
            <div class="form-group mb-3">
              ...
              <input
                ...
                required
                <%-- [FIX Reflected XSS] Input value attr - user-supplied query param --%>
                value="<c:out value='${input}'/>"
              />
            </div>
