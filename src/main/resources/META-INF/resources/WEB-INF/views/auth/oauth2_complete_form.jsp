  ...
  <body class="login-page">
    ...
    <div class="login-container">
      <div class="login-card">
        ...
        <form
          action="${pageContext.request.contextPath}/oauth2/complete"
          method="post"
        >
          <%-- ✅ CSRF Token --%>
          <input
          ...
          <div class="mb-3">
            ...
            <small
              ...
              "
            >
              <i class="fa fa-info-circle"></i> Email từ tài khoản Google không
              thể thay đổi
            </small>
          </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              name="fullName"
              class="form-control"
              value="<c:out value='${not empty fullName ? fullName : name}'/>"
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label class="form-label">
                ...
                <span style="color: #8d99ae; font-size: 12px; font-weight: 400"
                  >(không bắt buộc)</span
                >
              </label>
              <input
