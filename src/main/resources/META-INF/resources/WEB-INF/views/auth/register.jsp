  ...
  <body class="register-page">
    ...
    <div class="register-container">
      ...
      >
        ...
        <div class="form-row">
          <div class="form-col">
            ...
            <small class="text-muted">
              <i class="fa fa-info-circle"></i> Số điện thoại phải có đúng 10
              chữ số
            </small>
          </div>
          <div class="form-col">
        ...
        <h2 class="section-title"><i class="fa fa-lock"></i> Tạo mật khẩu</h2>
        ...
        <div class="form-row">
          <div class="form-col">
            ...
            />
            <small class="text-muted">
              <i class="fa fa-info-circle"></i> Mật khẩu 12–128 ký tự, có chữ
    ...
    <script nonce="${cspNonce}">
      ...
      document
        ...
        .addEventListener("submit", function (e) {
          ...
          // Kiểm tra mật khẩu (tối thiểu 12 ký tự, có chữ hoa, thường, số và ký tự đặc biệt)
          const passwordRegex =
            /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[!@#$%^&*()\-_=+\[\]{}|;':,./<>?]).{12,128}$/;
          if (!passwordRegex.test(password)) {
            e.preventDefault();
            showValidationError(
              "Mật khẩu phải có 12–128 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt (ví dụ: !@#$%/...)!",
