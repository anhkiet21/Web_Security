  ...
  <body class="login-page">
    ...
    <div class="login-container">
      <div class="login-card">
        ...
        <p class="subtitle">
          Tài khoản của bạn đã được tạo. Vui lòng xác thực số điện thoại để hoàn
          tất.
        </p>
        ...
        <div class="mb-4 p-3" style="background: #f8f9fa; border-radius: 8px">
          ...
          >
            ...
            >
              <i
                class="fa fa-check"
                style="color: #4caf50; font-size: 11px"
              ></i>
        ...
        >
          <p
            style="margin: 0; font-size: 13px; color: #856404; line-height: 1.6"
          >
            <i
              class="fa fa-info-circle"
              style="color: #ffc107; margin-right: 6px"
            ></i>
            <strong>Lưu ý:</strong> Bạn đã được đăng nhập tự động sau khi đăng
            ký. Vui lòng xác thực số điện thoại để bảo vệ tài khoản tốt hơn.
          </p>
        </div>
        ...
        <div id="otpSection">
          ...
          <button
            type="button"
            onclick="verifyOTP()"
            class="btn btn-login w-100 text-white mb-3"
            id="verifyOtpBtn"
            disabled
          >
        ...
        <form
          method="post"
          action="${pageContext.request.contextPath}/register-phone-skip"
          style="margin: 0"
        >
          <%-- ✅ CSRF Token --%>
          <input
    ...
    <script>
          ...
          .then((data) => {
            if (data.success) {
              ...
              const interval = setInterval(() => {
                countdown--;
                sendBtn.innerHTML =
                  '<i class="fa fa-clock-o"></i> Gửi lại sau ' +
                  countdown +
                  "s";
                ...
                if (countdown <= 0) {
                  ...
                  sendBtn.innerHTML =
                    '<i class="fa fa-paper-plane"></i> Gửi lại mã OTP';
                }
              }, 1000);
            } else {
      ...
      function verifyOTP() {
        ...
        verifyBtn.innerHTML =
          '<i class="fa fa-spinner fa-spin"></i> Đang xác thực...';
